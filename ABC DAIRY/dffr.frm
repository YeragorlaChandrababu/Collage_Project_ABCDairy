...
Begin VB.Form dffr 
   ...
   Begin MSAdodcLib.Adodc adogrid 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM Formerdb"
      Caption         =   ""
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Label Label9 
      ...
      Caption         =   "Press Refress Button Once."
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   8.25
         Charset         =   0
...
dealerformerenvi.Command1 lblu
dealerformersreport.Show
dealerformersreport.Refresh
dealerformerenvi.rsCommand1.Close
End Sub
...
adogrid.RecordSource = "select * FROM formerdb where assdid='" + lblu.Caption + "'"
adogrid.Refresh
